...
#Set a instance name
instance_name = 'RAFT-1#MACROELEMENT-1'

#CreateSurface
for j in range(1, Number_Layer+1, 1):

    string_1 = 'Raft_LeftSur_Layer{}'.format(j)
...
for k in range(1, Number_Layer+1, 1):
    ...
    string_1 = 'Raft_Layer_{}'.format(k)
    string_2 = 'Raft_Conv_Left_Layer{}'.format(k)
    string_3 = 'Raft_LeftSur_Layer{}'.format(k)
    string_4 = 'Raft_Radia_Left_Layer{}'.format(k)
