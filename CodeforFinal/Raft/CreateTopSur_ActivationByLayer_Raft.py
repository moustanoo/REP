...
for j in range(1, Number_Layer+1, 1):
    ...
    string_1 = 'RAFT_TOPSUR_LAYER_{}'.format(j)
    string_2 = 'Raft_Layer_{}'.format(j)
    string_3 = 'Raft_Conv_Top_Layer_{}'.format(j)
    string_4 = 'Raft_Radia_Top_Layer_{}'.format(j)
    set_name = 'RAFT-1#MACROELEMENT-1.MACRO-LAYER-{}'.format(j)
